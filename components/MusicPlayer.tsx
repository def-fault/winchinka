...
const MusicPlayer: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50">
      ...
      {/* Main Player UI */}
      <div className={`transition-all duration-300 ease-in-out ${isExpanded ? 'w-72 md:w-80 glass-panel rounded-xl p-4 shadow-[0_0_25px_rgba(59,130,246,0.3)]' : 'w-14 h-14 rounded-full'
        }`}>
        {isExpanded ? (
          <div className="flex flex-col gap-3">
            ...
            <div className="py-2">
              ...
              <div className="flex flex-col gap-1">
                <input
                  ...
                  value={currentTime}
                  onChange={handleSeek}
                  className="w-full h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:bg-game-accent [&::-webkit-slider-thumb]:rounded-full"
                />
            ...
            <div className="flex items-center justify-center gap-4 mb-2">
              ...
              <button
                ...
                className={`p-3 text-white rounded-full shadow-lg hover:scale-105 transition-transform ${hasError ? 'bg-gray-600' : 'bg-gradient-to-tr from-game-primary to-game-accent'
                  }`}
              >
          ...
          <button
            ...
            className={`w-full h-full rounded-full flex items-center justify-center transition-all duration-300 shadow-lg relative ${isPlaying && !hasError
